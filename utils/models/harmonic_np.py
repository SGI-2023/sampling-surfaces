...
class HarmonicNeuralProcess(nn.Module):
    ...
    """
    def __init__(self, x_dim, y_dim, r_dim, z_dim, h_dim, n_harmonic_functions=12):
        super(HarmonicNeuralProcess, self).__init__()
        self.x_dim = x_dim
        self.y_dim = y_dim
        self.r_dim = r_dim
        self.z_dim = z_dim
        ...
        embedding_dim = n_harmonic_functions * 2 * x_dim

        self.xy_to_r = Encoder(embedding_dim, y_dim, h_dim, r_dim)
    ...
    def xy_to_mu_sigma(self, x, y):
        ...
        embeds = self.harmonic_embedding(x_flat)
        r_i_flat = self.xy_to_r(embeds, y_flat)
